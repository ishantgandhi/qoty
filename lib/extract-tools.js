const fieldSchema = {
  ...
  required: ["value", "basis", "is_estimate", "source"],
    ...
    input_examples: [
      {
        ...
        meeting_room_total: {
          value: 0,
          basis:
            "waived with $20,000 F&B minimum (single stated threshold, no other conditions)",
          is_estimate: false,
          source: "Pasted email",
        },
        fb_total: {
      ...
      },
      {
        total_quote: {
          value: 139600,
          basis:
            "sum of guestroom_total + meeting_room_total (estimated) + fb_total",
          is_estimate: true,
          source: null,
        },
        guestroom_total: {
        ...
        meeting_room_total: {
          value: 0,
          basis:
            "waiver requires 85% block utilization AND F&B minimum; utilization not confirmed, assumed likely given group size — this is an estimate",
          is_estimate: true,
          source: "sample_3.pdf",
        },
        fb_total: {
      ...
      },
      {
        total_quote: {
          value: null,
          basis:
            "No data found for this field after scanning the provided text.",
          is_estimate: false,
          source: null,
        },
        guestroom_total: {
      ...
      },
      {
        total_quote: {
          value: 40000,
          basis:
            "stated as an all-inclusive package price of $500/person for 80 attendees; not broken down further in the source text",
          is_estimate: false,
          source: "Pasted email",
        },
        guestroom_total: {
          value: null,
          basis:
            "price is bundled into an all-inclusive package total and cannot be broken down from the text",
          is_estimate: false,
          source: null,
        },
        meeting_room_total: {
